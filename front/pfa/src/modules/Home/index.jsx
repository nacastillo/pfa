function Home() {
    ...
    return (
        <>
            ...
            <section>
                <h2>Casos de uso del vigilante</h2>
                <img src="/1 CU Vigil.png" style = {{margin: "20px"}}></img>
            </section>
            <section>
                <h2>Casos de uso del investigador</h2>
                <img src="/2 CU Inves.png" style = {{margin: "20px"}}></img>
            </section>
            <section>
                <h2>Casos de uso del administrador</h2>
                <img src="/3 CU Admin.png" style = {{margin: "20px"}}></img>
            </section>
            <section>
                <h2>Diagrama de entidades</h2>
                <img src="/ERD.png" style = {{margin: "20px"}}></img>
            </section>
        </>
    )
}
