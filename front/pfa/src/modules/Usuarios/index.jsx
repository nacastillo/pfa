...
function mostrarServicios(col) {
    const col2 = []
    for (let x of col) {
        col2.push(<p>
                    Fecha: {x.fecha}, 
                    Sucursal: {x.sucursal}, 
                    Nombre de la sucursal: {x.nombreSucursal || "no tiene"},
                    incluye arma: {x.armado? "sí": "no"}
                </p>);
    }
    return col2;
}
...
function Usuarios() {
    ...
    const { autenticado, rol, esAdmin, esInves, esVigi, getServicios } = useContext(AuthContext);
